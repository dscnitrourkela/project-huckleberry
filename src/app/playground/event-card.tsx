...
const EventCard: React.FC<EventCardProps> = ({ event }) => {
  return (
    <div className="p-4 w-full transform transform-transition m-5 duration-300 hover:scale-105 max-w-xs mx-auto md:max-w-full bg-white rounded-xl shadow-[0px_1px_2px_0px_rgba(0,0,0,0.30),_0px_2px_6px_2px_rgba(0,0,0,0.15)] flex flex-col gap-4 md:gap-6">
