...
const EventsCard: React.FC<EventsCardProps> = ({
  ...
  return (
    <div className="w-full flex flex-col items-center font-product-sans-regular px-4 sm:px-6 lg:px-8">
      {/* Header */}
      ...
      >
        ...
        <p className="text-sm sm:text-base text-[#4A4A68] mt-4 leading-relaxed">
          {description}
        </p>
        <Link href={`/events/${id}`}>
