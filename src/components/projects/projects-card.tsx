  ...
  return (
    ...
    >
      ...
      <div className="mb-4 md:mb-6">
        ...
        <p className="text-sm md:text-base font-productsans text-gray-900 text-left w-full md:w-4/5 lg:w-3/5 whitespace-pre-line">
          {description}
        </p>
      </div>

      <div className="flex flex-col mt-4 sm:mt-6 md:mt-8 w-full gap-4 md:gap-8">
