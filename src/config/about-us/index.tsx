...
export const trackData = [
  {
    ...
    description:
      'Dive into the world of web technologies! Our web development domain covers everything from front-end frameworks to back-end architectures, enabling members to build dynamic, responsive, and user-friendly websites and applications.',
    bgColor: 'bg-[#ECF3FE]',
  ...
  },
  {
    ...
    title: 'AI/ML',
    description:
      'Explore the fascinating fields of Artificial Intelligence and Machine Learning. We conduct hands-on workshops, projects, and discussions on topics like data science, neural networks, and deep learning, preparing members for the future of intelligent systems.',
    bgColor: 'bg-[#FDEDEB]',
  ...
  },
  {
    ...
    title: 'UI/UX Design',
    description:
      'Design is at the heart of every great product. Our UI/UX Design domain focuses on user-centered design principles, prototyping, and usability testing, helping members create intuitive and impactful digital experiences.',
    bgColor: 'bg-[#FFF9E6]',
  ...
  },
  {
    ...
    title: 'Blockchain',
    description:
      'Discover the potential of decentralized technologies. In our Blockchain domain, members learn about smart contracts, cryptocurrencies, and distributed ledger systems, and work on projects that harness the power of blockchain for real-world applications.',
    bgColor: 'bg-[#EBF7EE]',
